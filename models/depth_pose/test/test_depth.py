...
batch size : How many images you want to pass for single pass

img_height,img_width : 256,512 , should be 256,512, because the network was trained with this height and width

dataset_dir : where the test_data is located

output_dir : where you want to save the predictions. even if the folder is not there it will create and save the results into that

ckpt_file : This is the checkpoint file, mostly it will be in the checkpoints folder

test_file : This is a txt file which contains all the filenames. Suppose the dataset directory is /home/user/Desktop and your data is on Desktop in 1-m folder then the filenames file shoudld only contain 1-m/000000.png, 1-m/000001.png..........,1-m/00000100.png 
